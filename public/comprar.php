                    ...
                    <?php foreach ($carrito->getLineas() as $id => $linea) : ?>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="py-4 px-6 text-center">
                                <p class="<?= $precioCupon != '' ? 'text-red-600' : '' ?>" style="<?= $precioCupon != '' ? 'text-decoration: line-through' : '' ?>"><?= dinero($precio) ?></p>
                                <p class="<?= $precioCupon != '' ? 'text-green-700 font-bold' : '' ?>"><?= $precioCupon != '' ? dinero($precioCupon) : '' ?></p>
                            </td>
                            <td class="py-4 px-6 text-center">
